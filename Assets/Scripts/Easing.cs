...
public static class Easing
{
    ...
    public delegate float Function(float k);


    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static float Linear(float k) => k;

    public static readonly IReadOnlyDictionary<Type, Function> Map = new Dictionary<Type, Function>
    {
        { Type.Linear, Linear },
        ...
        { Type.QuinticIn, Quintic.In },
        { Type.QuinticOut, Quintic.Out },
        { Type.QuinticInOut, Quintic.InOut },
    ...
    public class Quadratic
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float Loop(float k)
        {
            var a = 2 * k - 1.0f;
            return (a * -a) + 1;
        }
