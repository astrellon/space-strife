...
{
    public readonly struct ArrayValue : IArrayValue, IObjectValue
    {
        #region Fields
        // Static
        public static ArrayValue Empty = new(new IValue[0]);

        private readonly static IReadOnlyList<string> Keys = new [] { "length" };
