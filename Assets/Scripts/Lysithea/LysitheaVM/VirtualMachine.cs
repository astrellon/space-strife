...
namespace LysitheaVM
{
    public partial class VirtualMachine
    {
        ...
        public void CallFunctionToReturn(IFunctionValue value, int numArgs)
        {
            var stackTraceSize = this.stackTrace.Index;

            var args = this.GetArgs(numArgs);
            value.Invoke(this, args, true);
            ...
            {
                this.Step();
                if (stackTraceSize >= this.stackTrace.Index)
                {
                    this.Running = false;
                    this.Paused = true;
                }
